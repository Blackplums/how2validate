...
const mdxPath = path.join(process.cwd(), "contents/docs/introduction/supported-secret/index.mdx");
// Read and parse JSON
...
// Build MDX table
const tableHeader = "| Partner                           | Service                      |\n| :-------------------------------- | :--------------------------  |";
const tableRows = rows.map(([partner, service]) => `| ${partner.padEnd(32)} | ${service.padEnd(26)} |`);
const mdxTable = rows.length > 0
