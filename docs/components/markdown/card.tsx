...
type CardProps = PropsWithChildren & {
  ...
  variant?: "normal" | "small" | "image" | "blog"
}
  ...
  const content = (
      ...
      className={clsx(
        ...
        variant === "small"
          ...
          : variant === "image"
            ...
            : variant === "blog"
              ? "flex-col justify-between bg-neutral-900 p-0"
    ...
    >
      ...
      <div>
        ...
        {subtitle && variant === "blog" && (
          <p className="!my-1 px-4 pt-2 text-xs font-semibold text-gray-500 dark:text-gray-400">
            {subtitle}
          </p>
        )}
        {image && variant === "image" && (
        ...
        {description && variant === "blog" && (
          <p className="!my-2 px-4 text-sm font-normal text-gray-600 dark:text-gray-400">
            {description}
          </p>
        )}
      </div>
